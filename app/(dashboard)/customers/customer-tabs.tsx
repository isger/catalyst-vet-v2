...
export function ActiveCustomers({ initialData, searchQuery }: ActiveCustomersProps) {
  ...
  const finalCustomers = customers || initialData?.data || []
  const finalTotal = total || initialData?.total || 0
  ...
  return (
    <div className="space-y-6">
      ...
      {finalCustomers.length === 0 && !loading ? (
          ...
          <Table className="[--gutter:--spacing(6)] lg:[--gutter:--spacing(10)]">
            <TableHead>
              <TableRow>
                ...
                <SortableHeader
                  sortKey="email"
                  currentSort={getCurrentSort('email')}
                  onSort={handleSort}
                >
                  Email
                </SortableHeader>
                <SortableHeader
                  sortKey="phone"
                  currentSort={getCurrentSort('phone')}
                  onSort={handleSort}
                >
                  Phone
                </SortableHeader>
                <SortableHeader
                  sortKey="petCount"
                  currentSort={getCurrentSort('petCount')}
                  onSort={handleSort}
                >
                  Pets
                </SortableHeader>
                <SortableHeader
                  sortKey="lastVisit"
                  currentSort={getCurrentSort('lastVisit')}
                  onSort={handleSort}
                >
                  Last Visit
                </SortableHeader>
                <SortableHeader
                  sortKey="joinDate"
                  currentSort={getCurrentSort('joinDate')}
                  onSort={handleSort}
                >
                  Member Since
                </SortableHeader>
  ...
  const clients = useMemo(() => {
    let filtered = [
      ...
      },
      {
        ...
        inquiry: 'Training consultation',
        phone: '(555) 345-6789',
        email: 'john@example.com',
      },
      {
        name: 'Maria Garcia',
        pet: 'Fluffy (Persian Cat)',
        inquiry: 'Grooming consultation',
        phone: '(555) 456-7890',
  ...
  return (
    <div className="space-y-6">
      ...
      {clients.length === 0 ? (
        <div className="text-center py-8 text-zinc-500 dark:text-zinc-400">
          {searchQuery
            ? 'No new clients found matching your search.'
    ...
    let filtered = [
      {
        customer: 'Sarah Johnson',
        pet: 'Max',
        action: 'Check vaccination records',
        priority: 'High',
        dueDate: '2024-01-15',
      },
      {
        customer: 'Mike Chen',
        pet: 'Luna',
        action: 'Schedule dental follow-up',
        priority: 'Medium',
        dueDate: '2024-01-20',
      },
      {
